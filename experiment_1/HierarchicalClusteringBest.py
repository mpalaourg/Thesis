...
if __name__ == "__main__":
    ...
    # combinedDataset_user_1.csv if the file created for the experiment one from 'output.py'
    ...
    modelAverage  = AgglomerativeClustering(n_clusters=4, affinity="precomputed", linkage='average').fit(distance)
